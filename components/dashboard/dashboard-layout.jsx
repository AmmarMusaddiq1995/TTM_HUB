    ...
    <div className="min-h-screen bg-gray-50">
        ...
        <div className="fixed inset-y-0 left-0 flex w-64 flex-col bg-white">
          <div className="flex h-16 items-center justify-between px-4 border-b">
            <Link href="/" className="flex items-center space-x-2">
              ...
              <div>
                <Image src="/logottm.png" alt="Faaz Financial Group" width={250} height={150} className=" object-contain" />
              </div>
            </Link>
            <Button
              variant="ghost"
      ...
      <div className="hidden lg:fixed lg:inset-y-0 lg:flex lg:w-64 lg:flex-col">
        <div className="flex flex-col flex-grow bg-white border-r border-gray-200">
          <div className="flex h-16 items-center px-4 border-b justify-center">
            <Link href="/" className="flex items-center space-x-2">
              <Image src="/logottm.png" alt="The Talent Management Hub" width={120} height={150} className=" object-contain" />
            </Link>
          </div>
          <nav className="flex-1 px-4 py-4 space-y-2">
            {navigation.map((item) => (
