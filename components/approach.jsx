...
const Card = ({
  ...
  return (
    <div
      ...
      className="border border-black/[0.2]  group/canvas-card flex items-center justify-center bg-black  max-w-sm w-full mx-auto p-4 relative h-[20rem] relative">
