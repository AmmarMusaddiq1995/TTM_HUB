...
export default function GCIndexPage() {
  ...
  return (
    ...
    <main className="min-h-screen">
      ...
      <section className="py-20">
        <div className="mx-auto max-w-6xl px-6">
          <h2 className="text-3xl font-semibold mb-6">Subscriptions for sustainable impact</h2>
          <p className="text-slate-300 max-w-4xl">
            Subscription access allows organisations to embed GC language into everyday leadership routines. TTMHUB supports rollout, onboarding, facilitation, and integration — so insight actually changes how work gets done.
          </p>
        </div>
      </section>
