        ...
        <section className="bg-gradient-to-br from-primary/10 to-primary/5 py-20">
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto text-center">
              <Badge className="mb-4 bg-[#2bb673] text-white">Help Center</Badge>
              ...
              <div className="relative max-w-2xl mx-auto">
                ...
                <input
                  ...
                  className="w-full pl-12 pr-4 py-4 rounded-lg border border-gray-400 focus:outline-none focus:ring-2 focus:ring-[#2bb673] focus:border-transparent"
                />
              </div>
            </div>
          </div>
            ...
            <div className="grid md:grid-cols-3 gap-8 max-w-4xl mx-auto">
              <Card className="text-center">
                <CardContent className="pt-6">
                  <Phone className="h-12 w-12 text-[#2bb673] mx-auto mb-4" />
                  <h3 className="text-lg font-semibold mb-2">Call Us</h3>
                  <p className="text-gray-600 mb-4">Speak with a formation specialist</p>
                  <p className="text-[#2bb673] font-semibold">(844) 493-6249</p>
                </CardContent>
              </Card>

              <Card className="text-center">
                <CardContent className="pt-6">
                  <MessageCircle className="h-12 w-12 text-[#2bb673] mx-auto mb-4" />
                  <h3 className="text-lg font-semibold mb-2">Live Chat</h3>
                  <p className="text-gray-600 mb-4">Get instant help from our team</p>
                  <Button variant="outline" className="bg-[#2bb673] text-white hover:bg-[#2bb673]/90 cursor-pointer">Start Chat</Button>
                </CardContent>
              </Card>

              <Card className="text-center">
                <CardContent className="pt-6">
                  <Search className="h-12 w-12 text-[#2bb673] mx-auto mb-4" />
                  <h3 className="text-lg font-semibold mb-2">Help Center</h3>
                  <p className="text-gray-600 mb-4">Browse our knowledge base</p>
                  <Button variant="outline" className="bg-[#2bb673] text-white hover:bg-[#2bb673]/90 cursor-pointer">View Articles</Button>
                </CardContent>
              </Card>
            </div>
          </div>
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-2xl mx-auto text-center">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Button size="lg" className="bg-[#2bb673] hover:bg-[#2bb673]/90 cursor-pointer">
                  Contact Support
                </Button>
